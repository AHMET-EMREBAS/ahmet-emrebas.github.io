...
import { CreateQuantityDto } from '@ae/models/pms/quantity/dto/CreateQuantityDto';
import { UpdateQuantityDto } from '@ae/models/pms/quantity/dto/UpdateQuantityDto';
...
@ApiTags('pms | Quantity')
@Controller('pms/quantity')
