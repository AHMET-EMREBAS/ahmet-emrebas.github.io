...
import { DepartmentView } from '@ae/models/pms/department/DepartmentView';
import { DepartmentOptionView } from '@ae/models/pms/department/DepartmentOptionView';
import { CreateDepartmentDto } from '@ae/models/pms/department/dto/CreateDepartmentDto';
import { UpdateDepartmentDto } from '@ae/models/pms/department/dto/UpdateDepartmentDto';
...
@ApiTags('pms | Department')
@Controller('pms/department')
